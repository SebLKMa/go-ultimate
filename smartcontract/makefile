# https://courses.ardanlabs.com/courses/take/smart-contracts-with-go/lessons/42928364-day-2-training-with-bill-kennedy-feb-14-2023
...
# Downloaded and copied to ~/eth/bin
...
# dev mode 
# - txn immediately mine, no other nodes. 
# - make sure datadir "zarf/ethereum/" exists.
# - using the account in --unlock 0x..., 
# - inside keystore directory, file suffix with public addresses
geth-up:
...
# You will see
# INFO [08-08|07:49:06.550] Unlocked account      address=0x6327A38415C53FFb36c11db55Ea74cc9cB4976Fd
...
# See also: https://github.com/ardanlabs/smartcontract/issues/11  
geth-deposit:
